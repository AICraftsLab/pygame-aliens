...
class Agent():
    def __init__(self, gamma, policy_clip,lamda, adam_lr,
        ...
        self.actor = ActorNwk(input_dim=state_dim,out_dim=action_dim,adam_lr=adam_lr,chekpoint_file='./saves2/actor')
        self.critic = CriticNwk(input_dim=state_dim,adam_lr=adam_lr,chekpoint_file='./saves2/critic')
...
rewards_file_name = './saves2/rewards.txt'
...
if load_state:
    ...
    load_episode = 0
n_games = 10000
figure_file = './saves2/learning_curve.png'
best_score = 0
learn_iters = 0
avg_score = 0
n_steps = 0
